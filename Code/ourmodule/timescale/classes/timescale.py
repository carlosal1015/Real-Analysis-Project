class Timescale:
    def __init__(self, ts, name = 'ninguno'):#plt
        ...
        print("Escala de tiempo construida con éxito:")
        print("Escala de tiempo:", self.ts)
        print("Nombre de la escala de tiempo:", self.name)