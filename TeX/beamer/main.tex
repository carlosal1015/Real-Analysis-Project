...
\begin{example}[Triangulación]
		...
		\end{figure}
\end{example}
\begin{example}[Caminos monótonos]
		...
		\end{figure}
\end{example}
\begin{example}[Árboles binarios]
	\begin{figure}
	\centering
...
consecutivos $n_{0}, n_{0}+1,\cdots ,n_{0}+k-1$ tome los valores
dados $c_{0}, c_{1},\cdots , c_{k-1}$; tiene solución única.
