...
\begin{frame}
\frametitle{\subsecname}%\beamergotobutton{right}\secname\hspace{0pt plus 1 filll}\subsecname
...
\begin{definition}
Una sucesión ${\left(a_{n}\right)}_{n}$ es una \textbf{solución} de~\eqref{eq:recurrence}, sii \[ \left(a_{0},\ldots,a_{n-1}\right)\in D_{n},\quad a_{n}=f_{n}\left(a_{0},a_{1},\ldots,a_{n-1}\right)\quad\forall\,n\geq r. \]
\end{definition}
\end{frame}
